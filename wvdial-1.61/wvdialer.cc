...
/************************/
{
	...
	(options.software_flow_control) ? "xonxoff" : NULL,  	
	(options.software_flow_control) ? "asyncmap" : NULL, 	
	(options.software_flow_control) ? (const char *) options.asyncmap : NULL,  	
